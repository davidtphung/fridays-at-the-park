...
export const MOCK_TRACKS: Track[] = [
  ...
  // --- S002 Episode 3 (audio — Highlight) ---
  {
    ...
    mediaType: MediaType.AUDIO,
    coverImage: 'https://via.placeholder.com/800x800/1C1C2E/22C55E?text=S002+E3',
    coverImageSmall: 'https://via.placeholder.com/400x400/1C1C2E/22C55E?text=S002+E3',
    audioUrl: '/audio/sample.mp3',
    duration: 300,
    season: 'S002',
    episode: 3,
  ...
  // --- Onchain: Zora — Fridays at the Park 006 (Valentine Recording Studios, LA) ---
  {
    ...
    mediaType: MediaType.AUDIO,
    coverImage: 'https://via.placeholder.com/800x800/1C1C2E/E94560?text=006',
    audioUrl: '/audio/sample.mp3',
    duration: 300,
    platform: Platform.ZORA,
    chain: Chain.ETHEREUM,
  ...
  // --- Onchain: Zora — The Park DAO ---
  {
    ...
    mediaType: MediaType.AUDIO,
    coverImage: 'https://via.placeholder.com/800x800/0A0A0F/A1A1AA?text=The+Park+DAO',
    audioUrl: '/audio/sample.mp3',
    duration: 0,
    platform: Platform.ZORA,
    chain: Chain.ETHEREUM,
  ...
  // --- Onchain: Zora — Onchain Summer (standalone Zora mint) ---
  {
    ...
    mediaType: MediaType.AUDIO,
    coverImage: 'https://via.placeholder.com/800x800/1C1C2E/F5A623?text=Onchain+Summer',
    audioUrl: '/audio/sample.mp3',
    duration: 240,
    bpm: 127,
    platform: Platform.ZORA,
